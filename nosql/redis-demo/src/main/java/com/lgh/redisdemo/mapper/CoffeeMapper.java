package com.lgh.redisdemo.mapper;
...
public interface CoffeeMapper {
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.lgh.redisdemo.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.lgh.redisdemo.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set name = #{name,jdbcType=VARCHAR},",
          "price = #{price,jdbcType=BIGINT,typeHandler=com.lgh.redisdemo.handler.MoneyTypeHandler},",
