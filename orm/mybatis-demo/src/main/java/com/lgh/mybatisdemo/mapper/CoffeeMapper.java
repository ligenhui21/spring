package com.lgh.mybatisdemo.mapper;
...
public interface CoffeeMapper {
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.lgh.mybatisdemo.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.lgh.mybatisdemo.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=com.lgh.mybatisdemo.handler.MoneyTypeHandler},",
